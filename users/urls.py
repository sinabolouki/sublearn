...
urlpatterns = [
    ...
    path(r'login/', TemplateView.as_view(template_name='users/login.html'), name="login"),
    path(r'logout/', TemplateView.as_view(template_name='users/logout.html'), name="logout"),
